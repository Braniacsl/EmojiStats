...
# Note: You might also want an on_reaction_remove handler if you need to track removals,
# but the task description only explicitly mentions tracking additions.
